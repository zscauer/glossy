...
public final class ModeratorProfile extends AccessProfile {

    AccessMode accessMode = AccessMode.MODERATOR;
    ...
    public ModeratorProfile(@ConfigProperty(name = "configuration.security.access-mode.moderator.secret") final String secret) throws InvalidKeySpecException {
